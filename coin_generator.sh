...
#KyTAYPi4xiriA2D9mtXtDFPmkDM189SP4ynBRrUFgp7yKheHqeHJ
#Public Key (130 characters [0-9A-F]):
#0453CFDD3313102996DE46D0E82C52946B120463DE1F6A1FF4BCFCF2B9A2BB75C5B0B7B84E892A1973BF3A3E19D5A4C4A3FDA4766CB75B6B8837F3BB23D63AAC96
#Public Key (compressed, 66 characters [0-9A-F]):
#0253CFDD3313102996DE46D0E82C52946B120463DE1F6A1FF4BCFCF2B9A2BB75C5
...
generate_genesis_block()
{
    ...
    if [ ! -f ${COIN_NAME}-main.txt ]; then
        ...
        python $DIRNAME/GenesisH0/genesis.py -a scrypt -z "$PHRASE" -p $GENESIS_REWARD_PUBKEY 2>&1 | tee /GenesisH0/${COIN_NAME}-main.txt
    else
    ...
    if [ ! -f ${COIN_NAME}-test.txt ]; then
        ...
        python $DIRNAME/GenesisH0/genesis.py  -t 1486949366 -a scrypt -z "$PHRASE" -p $GENESIS_REWARD_PUBKEY 2>&1 | tee /GenesisH0/${COIN_NAME}-test.txt
    else
        echo "Genesis block already mined.."
    ...
    if [ ! -f ${COIN_NAME}-regtest.txt ]; then
        ...
        python $DIRNAME/GenesisH0/genesis.py -t 1296688602 -b 0x207fffff -n 0 -a scrypt -z "$PHRASE" -p $GENESIS_REWARD_PUBKEY 2>&1 | tee /GenesisH0/${COIN_NAME}-regtest.txt
    else
        echo "Genesis block already mined.."
